...
import { Users, AlertCircle, Cloud, Database } from "lucide-react";
...
/**
 * Modal for creating runtime permissions for dataset access
 *
...
> = ({ isOpen, onClose, datasetId, onSuccess }) => {
  ...
  const [task, setTask] = useState("vanaorg/vana-task-demo:latest");
  ...
  useEffect(() => {
    if (isOpen) {
      setGrantee("");
      setTask("vanaorg/vana-task-demo:latest");
      ...
      <ModalContent>
          ...
          <div className="space-y-4">
            ...
            <div className="bg-primary/5 p-3 rounded-lg">
              ...
              <Input
                ...
                placeholder="vanaorg/vana-task-demo:latest"
                description="Docker image reference for the Vana Runtime task"
                isRequired
              />
              ...
              >
                <SelectItem
                  key="aggregate_keywords"
                  textValue="Aggregate Keywords"
                >
                  Aggregate Keywords
                </SelectItem>
              ...
              <div className="space-y-3 mt-3">
                <Input
                  ...
                  value={pricePerFile}
                  onChange={(e) => {
                    setPricePerFile(e.target.value);
                  }}
                  placeholder="0.1"
        ...
        <ModalFooter>
          ...
          <Button
            ...
            startContent={
              !isCreating ? <Users className="h-4 w-4" /> : undefined
            }
          >
