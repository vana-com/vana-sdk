...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log(
      "⚠️ Note: Permission revocation not yet implemented in PermissionRegistry contract",
    );
    ...
    return NextResponse.json(
      {
        success: false,
        error:
          "Permission revocation not yet implemented in the smart contract. Please check with the protocol team.",
      },
      { status: 501 },
    ); // 501 Not Implemented
  } catch (error) {
