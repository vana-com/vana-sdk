...
export type Fn<C extends Contract> = C extends "AccessSettlement"
  ?
      | "grantRole"
      | "initialize"
      | "logOperation"
      ...
      | "settlePaymentWithToken"
      | "upgradeToAndCall"
  : C extends "AttestationPolicy"
    ?
        | "grantRole"
        | "initialize"
        | "renounceRole"
        ...
        | "untrustTeePool"
        | "untrustVanaRuntimeImage"
        | "upgradeToAndCall"
    : C extends "ComputeEngine"
      ?
          | "deposit"
          | "grantRole"
          | "initialize"
                                                                ...
                                                                : C extends "VanaPoolStaking"
                                                                  ...
                                                                  : C extends "VanaPoolTreasury"
                                                                    ?
                                                                        ...
                                                                        | "upgradeToAndCall"
                                                                        | "withdraw"
                                                                    : C extends "VanaRuntimePermissions"
                                                                      ?
                                                                          | "createPermission"
                                                                          | "grantRole"
                                                                          | "initialize"
...
export type EventNameMap = {
  "AccessSettlement.grantRole": "RoleGranted";
  "AccessSettlement.initialize": "Initialized";
  "AccessSettlement.logOperation": "OperationReadyForSettlement";
  "AccessSettlement.renounceRole": "RoleRevoked";
  "AccessSettlement.revokeRole": "RoleRevoked";
  "AccessSettlement.settlePaymentWithNative": "PaymentSettled";
  "AccessSettlement.settlePaymentWithToken": "PaymentSettled";
  "AccessSettlement.upgradeToAndCall": "Upgraded";
  "AttestationPolicy.grantRole": "RoleGranted";
  "AttestationPolicy.initialize": "Initialized";
  "AttestationPolicy.renounceRole": "RoleRevoked";
  "AttestationPolicy.revokeRole": "RoleRevoked";
  "AttestationPolicy.trustTeePool": "TeePoolTrusted";
  "AttestationPolicy.trustVanaRuntimeImage": "VanaRuntimeImageTrusted";
  "AttestationPolicy.untrustTeePool": "TeePoolUntrusted";
  "AttestationPolicy.untrustVanaRuntimeImage": "VanaRuntimeImageUntrusted";
  "AttestationPolicy.upgradeToAndCall": "Upgraded";
  ...
  "DatasetRegistry.acceptFile": "FileAccepted";
  "DatasetRegistry.addPendingFile": "FileAddedToDataset";
  "DatasetRegistry.createDataset": "DatasetCreated";
  "DatasetRegistry.grantRole": "RoleGranted";
  "DatasetRegistry.initialize": "Initialized";
  "DatasetRegistry.rejectFile": "FileRejected";
  "DatasetRegistry.renounceRole": "RoleRevoked";
  "DatasetRegistry.revokeRole": "RoleRevoked";
  "DatasetRegistry.transferDatasetOwnership": "DatasetOwnershipTransferred";
  "DatasetRegistry.upgradeToAndCall": "Upgraded";
  "ProtocolConfig.grantRole": "RoleGranted";
  "ProtocolConfig.initialize": "Initialized";
  "ProtocolConfig.renounceRole": "RoleRevoked";
  "ProtocolConfig.revokeRole": "RoleRevoked";
  "ProtocolConfig.updateAttestationPolicy": "AttestationPolicyUpdated";
  "ProtocolConfig.updatePGEPublicKey": "PGEPublicKeyUpdated";
  "ProtocolConfig.updatePGERecoveryCommittee": "PGERecoveryCommitteeUpdated";
  "ProtocolConfig.upgradeToAndCall": "Upgraded";
  ...
  "VanaRuntimePermissions.createPermission": "PermissionCreated";
  "VanaRuntimePermissions.grantRole": "RoleGranted";
  "VanaRuntimePermissions.initialize": "Initialized";
  "VanaRuntimePermissions.renounceRole": "RoleRevoked";
  "VanaRuntimePermissions.revokePermission": "PermissionRevoked";
  "VanaRuntimePermissions.revokeRole": "RoleRevoked";
  "VanaRuntimePermissions.updatePermission": "PermissionUpdated";
  "VanaRuntimePermissions.upgradeToAndCall": "Upgraded";
  "VanaRuntimeServers.deactivateServer": "ServerDeactivated";
  "VanaRuntimeServers.grantRole": "RoleGranted";
  "VanaRuntimeServers.initialize": "Initialized";
  "VanaRuntimeServers.reactivateServer": "ServerReactivated";
  "VanaRuntimeServers.registerServer": "ServerRegistered";
  "VanaRuntimeServers.renounceRole": "RoleRevoked";
  "VanaRuntimeServers.revokeRole": "RoleRevoked";
  "VanaRuntimeServers.updateServerUrl": "ServerUrlUpdated";
  "VanaRuntimeServers.upgradeToAndCall": "Upgraded";
};
...
export interface EventArgs {
  ...
  AttestationPolicyUpdated: {
    newAttestationPolicy: `0x${string}`;
  };
  Claimed: {
  ...
  PGERecoveryCommitteeUpdated: {
    newAddresses: readonly `0x${string}`[];
  };
  ProofAdded: {
    fileId: bigint;
    ownerAddress: `0x${string}`;
  ...
  VanaRuntimeImageTrusted: {
    imageVersion: string;
  };
  VanaRuntimeImageUntrusted: {
    imageVersion: string;
  };
