...
import type { VanaConfig, VanaConfigWithStorage, StorageRequiredMarker } from "./types";
/**
 ...
 * @category Core SDK
 */
export declare function Vana(config: VanaConfigWithStorage): VanaNodeImpl & StorageRequiredMarker;
export declare function Vana(config: VanaConfig): VanaNodeImpl;
/**
