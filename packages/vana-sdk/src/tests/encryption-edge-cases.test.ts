...
describe("Encryption Edge Cases Coverage", () => {
  describe("generateEncryptionKey", () => {
    it("should throw error when wallet account is missing", async () => {
      ...
      await expect(generateEncryptionKey(mockWallet, mockPlatformAdapter)).rejects.toThrow(
    ...
    it("should handle custom seed parameter", async () => {
      ...
      const result = await generateEncryptionKey(mockWallet, mockPlatformAdapter, "custom-seed");
