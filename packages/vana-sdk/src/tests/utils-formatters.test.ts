...
describe("Formatter Utils", () => {
  ...
  describe("formatToken", () => {
    ...
    it("should handle large amounts", () => {
      expect(formatToken(BigInt("1000000000000000000000000"), 18)).toBe(
        "1000000",
      );
    });
    ...
    it("should handle custom display decimals", () => {
      ...
      expect(formatToken(BigInt("1234567890123456789"), 18, 6)).toBe(
        "1.234567",
      );
    });
  });
  ...
  describe("Edge cases and error handling", () => {
    ...
    it("should handle zero values consistently", () => {
      ...
      expect(shortenAddress("0x0000000000000000000000000000000000000000")).toBe(
        "0x0000...0000",
      );
    });
  });
