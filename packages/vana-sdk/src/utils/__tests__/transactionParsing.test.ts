    ...
    if (params.eventName === 'PermissionAdded') {
      return [{
        ...
        args: {
          ...
          grant: 'https://cdn.vibes-moksha.vana.com/grants/1753281736304-grant-file.json',
          fileIds: [1654449n],
        }
      }];
    }
...
describe('parseTransactionResult', () => {
      ...
      logs: [
        {
          ...
          removed: false,
          topics: ['0x...'],
          transactionHash: '0xed8d0a7fe73032c681f9e30944e415363b808e114aa62386bcd69ac8bc25a645',
          transactionIndex: 0,
        } as Log,
      ],
  ...
  it('should parse PermissionAdded event correctly', async () => {
    const hash = '0xed8d0a7fe73032c681f9e30944e415363b808e114aa62386bcd69ac8bc25a645' as Hash;
    ...
    expect(mockContext.publicClient.waitForTransactionReceipt).toHaveBeenCalledWith({
      hash,
      timeout: 30_000,
    });
  });
  ...
  it('should throw error when no event is found', async () => {
    ...
    await expect(parseTransactionResult(mockContext, hash, 'grant'))
      .rejects
  ...
  it('should throw NetworkError on timeout', async () => {
    ...
    mockContext.publicClient.waitForTransactionReceipt = vi.fn()
