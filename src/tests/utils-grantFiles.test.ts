...
describe('Grant Files Utils', () => {
  ...
  describe('storeGrantFile', () => {
    ...
    it('should store grant file and return URL', async () => {
      ...
      const result = await storeGrantFile(mockGrantFile, 'https://relayer.test')
    ...
    it('should handle storage failure', async () => {
      ...
      await expect(storeGrantFile(mockGrantFile, 'https://relayer.test'))
  ...
  describe('retrieveGrantFile', () => {
    ...
    it('should handle 404 responses', async () => {
      ...
      await expect(retrieveGrantFile('ipfs://QmMissing'))
    ...
    it('should handle timeout', async () => {
      ...
      await expect(retrieveGrantFile('ipfs://QmTimeout'))
        .rejects.toThrow('Failed to retrieve grant file from any IPFS gateway')
    })
    ...
    it('should handle malformed JSON', async () => {
      ...
      await expect(retrieveGrantFile('ipfs://QmBadJSON'))
        .rejects.toThrow('Failed to retrieve grant file from any IPFS gateway')
    })
  })
})